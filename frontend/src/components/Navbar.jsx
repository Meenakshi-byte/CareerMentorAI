        ...
        <div className="flex items-center gap-3">
          <Link to="/" className="flex items-center gap-3">
            ...
            <div className="hidden sm:flex flex-col leading-tight">
              <span className="font-extrabold text-base text-slate-900 dark:text-slate-100">Career Mentor AI</span>
              <span className="text-[11px] uppercase tracking-[0.22em] text-slate-500 dark:text-slate-300">AI mentorship • career growth</span>
            </div>
          </Link>
        </div>
