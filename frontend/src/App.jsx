...
function AppRoutes() {
  return (
    <div className="min-h-screen flex flex-col bg-slate-50 text-slate-800 dark:bg-slate-950 dark:text-slate-100 transition-colors duration-300">
      ...
      <footer className="text-center text-slate-400 text-xs py-6 border-t border-slate-200 dark:border-slate-800">
        Career Mentor AI — Intelligent career guidance • Powered by ML &amp; React
      </footer>
    </div>
  )
}
